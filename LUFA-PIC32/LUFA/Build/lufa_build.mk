...
ifeq ($(ARCH), AVR8)
   ...
   CROSS        := xc32
   $(warning The PIC32 device support is currently EXPERIMENTAL (incomplete and/or non-functional), and is included for preview purposes only.)
else
