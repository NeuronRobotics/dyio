 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_Init(IP_CRC_001_Type *pCRC) {}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_DeInit(IP_CRC_001_Type *pCRC) {}
 ...
 */
STATIC INLINE void IP_CRC_SetPoly(IP_CRC_001_Type *pCRC, CRC_001_POLY_T poly,
								  uint32_t flags)
{
 ...
 * @return	Nothing
 */
void IP_CRC_UseDefaultConfig(IP_CRC_001_Type *pCRC, CRC_001_POLY_T poly);
 ...
 */
STATIC INLINE uint32_t IP_CRC_GetMode(IP_CRC_001_Type *pCRC)
{
	return pCRC->MODE;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_SetMode(IP_CRC_001_Type *pCRC, uint32_t mode)
{
	pCRC->MODE = mode;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_SetSeed(IP_CRC_001_Type *pCRC, uint32_t Seed)
{
	pCRC->SEED = Seed;
}
 ...
 */
STATIC INLINE uint32_t IP_CRC_GetSeed(IP_CRC_001_Type *pCRC)
{
	return pCRC->SEED;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_Write8(IP_CRC_001_Type *pCRC, uint8_t data)
{
	pCRC->WRDATA8 = data;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_Write16(IP_CRC_001_Type *pCRC, uint16_t data)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_CRC_Write32(IP_CRC_001_Type *pCRC, uint32_t data)
{
	pCRC->WRDATA32 = data;
}
 ...
 */
STATIC INLINE uint32_t IP_CRC_ReadSum(IP_CRC_001_Type *pCRC)
{
	return pCRC->SUM;
}
 ...
 */
uint32_t IP_CRC_CRC8(IP_CRC_001_Type *pCRC, const uint8_t *data, uint32_t bytes);
 ...
 * @return	Computed checksum for the block
 */
uint32_t IP_CRC_CRC16(IP_CRC_001_Type *pCRC, const uint16_t *data, uint32_t hwords);
 ...
 * @return	Computed checksum for the block
 */
uint32_t IP_CRC_CRC32(IP_CRC_001_Type *pCRC, const uint32_t *data, uint32_t words);
