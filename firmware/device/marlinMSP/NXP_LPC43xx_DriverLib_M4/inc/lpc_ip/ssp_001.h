 ...
 */
STATIC INLINE void IP_SSP_DeInit(IP_SSP_001_Type *pSSP)
{
 ...
 */
STATIC INLINE FlagStatus IP_SSP_GetStatus(IP_SSP_001_Type *pSSP, SSP_Status_Type Stat)
{
 ...
 */
STATIC INLINE uint32_t IP_SSP_GetIntStatus(IP_SSP_001_Type *pSSP)
{
	return pSSP->MIS;
}
 ...
 */
STATIC INLINE IntStatus IP_SSP_GetRawIntStatus(IP_SSP_001_Type *pSSP, SSP_Raw_Int_Status_Type RawInt)
{
 ...
 */
STATIC INLINE uint8_t IP_SSP_GetDataSize(IP_SSP_001_Type *pSSP)
{
 ...
 */
STATIC INLINE void IP_SSP_ClearIntPending(IP_SSP_001_Type *pSSP, SSP_Int_Clear_Type IntClear)
{
	pSSP->ICR = IntClear;
}
 ...
 */
STATIC INLINE uint16_t IP_SSP_ReceiveFrame(IP_SSP_001_Type *pSSP)
{
 ...
 * @return	 Nothing
 */
STATIC INLINE void IP_SSP_SendFrame(IP_SSP_001_Type *pSSP, uint16_t tx_data)
{
 ...
 */
STATIC INLINE void IP_SSP_Set_Format(IP_SSP_001_Type *pSSP, uint32_t bits, uint32_t frameFormat, uint32_t clockFormat)
{
 ...
 * @return	 Nothing
 */
STATIC INLINE void IP_SSP_Set_Mode(IP_SSP_001_Type *pSSP, uint32_t mode)
{
