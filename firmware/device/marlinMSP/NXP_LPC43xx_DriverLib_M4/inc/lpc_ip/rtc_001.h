 ...
 * @return	None
 */
void IP_RTC_Init(IP_RTC_001_Type *pRTC);
 ...
 * @return	None
 */
STATIC INLINE void IP_RTC_DeInit(IP_RTC_001_Type *pRTC)
{
	pRTC->CCR = 0x00;
}
 ...
 * @return	None
 */
void IP_RTC_ResetClockTickCounter(IP_RTC_001_Type *pRTC);
 ...
 * @return	None
 */
void IP_RTC_Enable(IP_RTC_001_Type *pRTC, FunctionalState NewState);
 ...
 * @return	None
 */
void IP_RTC_CntIncrIntConfig(IP_RTC_001_Type *pRTC, uint32_t cntrMask, FunctionalState NewState);
 ...
 * @return	None
 */
void IP_RTC_AlarmIntConfig(IP_RTC_001_Type *pRTC, uint32_t alarmMask, FunctionalState NewState);
 ...
 * @return	None
 */
void IP_RTC_SetTime(IP_RTC_001_Type *pRTC, IP_RTC_TIMEINDEX_T Timetype, uint32_t TimeValue);
 ...
 */
uint32_t IP_RTC_GetTime(IP_RTC_001_Type *pRTC, IP_RTC_TIMEINDEX_T Timetype);
 ...
 * @return	None
 */
void IP_RTC_SetFullTime(IP_RTC_001_Type *pRTC, IP_RTC_TIME_T *pFullTime);
 ...
 * @return	None
 */
void IP_RTC_GetFullTime(IP_RTC_001_Type *pRTC, IP_RTC_TIME_T *pFullTime);
 ...
 * @return	None
 */
void IP_RTC_SetAlarmTime(IP_RTC_001_Type *pRTC, IP_RTC_TIMEINDEX_T Timetype, uint32_t ALValue);
 ...
 */
uint32_t IP_RTC_GetAlarmTime(IP_RTC_001_Type *pRTC, IP_RTC_TIMEINDEX_T Timetype);
 ...
 * @return	None
 */
void IP_RTC_SetFullAlarmTime(IP_RTC_001_Type *pRTC, IP_RTC_TIME_T *pFullTime);
 ...
 * @return	None
 */
void IP_RTC_GetFullAlarmTime(IP_RTC_001_Type *pRTC, IP_RTC_TIME_T *pFullTime);
 ...
 * @return		None
 */
void IP_RTC_CalibCounterCmd(IP_RTC_001_Type *pRTC, FunctionalState NewState);
 ...
 * @return	None
 */
void IP_RTC_CalibConfig(IP_RTC_001_Type *pRTC, uint32_t CalibValue, uint8_t CalibDir);
 ...
 * @return	None
 */
STATIC INLINE void IP_RTC_ClearIntPending(IP_RTC_001_Type *pRTC, uint32_t IntType)
{
	pRTC->ILR = IntType;
}
 ...
 */
STATIC INLINE IntStatus IP_RTC_GetIntPending(IP_RTC_001_Type *pRTC, uint32_t IntType)
{
 ...
 */
STATIC INLINE void IP_RTC_EV_Config(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch, uint32_t flag)
{
	pRTC->ERCONTROL &= (~(RTC_ERCTRL_CHANNEL_CONFIG_BITMASK(ch))) & RTC_ERCTRL_BITMASK;
	pRTC->ERCONTROL |= RTC_ERCTRL_CHANNEL_CONFIG(ch, flag) & RTC_ERCTRL_BITMASK;
}
 ...
 * @return	None
 */
STATIC INLINE void IP_RTC_EV_SetMode(IP_RTC_001_Type *pRTC, IP_RTC_EV_MODE_T mode)
{
	pRTC->ERCONTROL &= (~RTC_ERCTRL_MODE_MASK) & RTC_ERCTRL_BITMASK;
	pRTC->ERCONTROL |= RTC_ERCTRL_MODE(mode);
}
 ...
 */
STATIC INLINE uint32_t IP_RTC_EV_GetStatus(IP_RTC_001_Type *pRTC)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_RTC_EV_ClearStatus(IP_RTC_001_Type *pRTC, uint32_t flag)
{
 ...
 */
STATIC INLINE FlagStatus IP_RTC_EV_GetChannelStatus(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch)
{
 ...
 * @return	Nothing.
 */
STATIC INLINE void IP_RTC_EV_ClearChannelStatus(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch)
{
 ...
 */
STATIC INLINE uint8_t IP_RTC_EV_GetCounter(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch)
{
 ...
 * @return	Nothing.
 */
void IP_RTC_EV_GetFirstTimeStamp(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch, IP_RTC_EV_TIMESTAMP_T *pTimeStamp);
 ...
 * @return	Nothing.
 */
void IP_RTC_EV_GetLastTimeStamp(IP_RTC_001_Type *pRTC, IP_RTC_EV_CHANNEL_T ch, IP_RTC_EV_TIMESTAMP_T *pTimeStamp);
