 ...
 * @return	Nothing
 */
void IP_DAC_Init(IP_DAC_001_Type *pDAC);
 ...
 * @return	Nothing
 */
void IP_DAC_UpdateValue (IP_DAC_001_Type *pDAC, uint32_t dac_value);
 ...
 * @return	Nothing
 */
void IP_DAC_SetBias (IP_DAC_001_Type *pDAC, uint32_t bias);
 ...
 * @return	Nothing
 */
void IP_DAC_ConfigDAConverterControl (IP_DAC_001_Type *pDAC, DAC_CONVERTER_CFG_Type *DAC_ConverterConfigStruct);
 ...
 * @return	Nothing
 */
void IP_DAC_SetDMATimeOut(IP_DAC_001_Type *pDAC, uint32_t time_out);
 ...
 */
IntStatus IP_DAC_GetIntStatus(IP_DAC_001_Type *pDAC);
