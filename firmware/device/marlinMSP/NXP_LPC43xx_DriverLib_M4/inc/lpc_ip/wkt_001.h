 ...
 * @return	Nothing
 */
STATIC INLINE void IP_WKT_ClearIntStatus(IP_WKT_001_Type *pWKT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_WKT_Stop(IP_WKT_001_Type *pWKT)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_WKT_SetClockSource(IP_WKT_001_Type *pWKT, IP_WKT_CLKSRC_T clkSrc)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_WKT_Start(IP_WKT_001_Type *pWKT, uint32_t cntVal)
{
	pWKT->COUNT = cntVal;
}
