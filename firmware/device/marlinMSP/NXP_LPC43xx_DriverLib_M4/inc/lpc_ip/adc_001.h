...
#if !defined(CHIP_LPC18XX) && !defined(CHIP_LPC43XX) && !defined(CHIP_LPC11XX)
	__IO uint32_t ADTRM;
#endif
} IP_ADC_001_Type;
 ...
 */
 ...
 #define ADC_CR_BITACC(n)        0	/*!< Number of ADC accuracy bit is not valid */
#endif
 ...
 * @return	Nothing
 * @note	Disable all ADC interrupts, set bit PDN, set ADC clock frequency
