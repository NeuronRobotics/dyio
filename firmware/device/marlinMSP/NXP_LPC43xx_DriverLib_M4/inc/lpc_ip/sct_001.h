 ...
 */
STATIC INLINE void IP_SCT_SetCount(IP_SCT_001_Type *pSCT, uint32_t count)
{
	pSCT->COUNT_U = count;
}
 ...
 */
STATIC INLINE void IP_SCT_SetCountL(IP_SCT_001_Type *pSCT, uint16_t count)
{
	pSCT->COUNT_L = count;
}
 ...
 */
STATIC INLINE void IP_SCT_SetCountH(IP_SCT_001_Type *pSCT, uint16_t count)
{
	pSCT->COUNT_H = count;
}
 ...
 */
STATIC INLINE void IP_SCT_SetMatchCount(IP_SCT_001_Type *pSCT, uint32_t n, uint32_t count)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SCT_SetMatchReload(IP_SCT_001_Type *pSCT, uint32_t n, uint32_t count)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SCT_EventIntEnable(IP_SCT_001_Type *pSCT, uint32_t evt)
{
	pSCT->EVEN |= evt;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SCT_EventIntDisable(IP_SCT_001_Type *pSCT, uint32_t evt)
{
	pSCT->EVEN &= ~(evt);
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SCT_ClearEventFlag(IP_SCT_001_Type *pSCT, uint32_t evt)
{
	pSCT->EVFLAG |= evt;
}
 ...
 */
void IP_SCT_ControlSetClr(IP_SCT_001_Type *pSCT, uint32_t value, FunctionalState ena);
