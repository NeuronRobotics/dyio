 ...
 */
typedef struct {
	IP_SPI_MODE             Mode;			/* Mode Select */
	IP_SPI_CLOCK_MODE       ClockMode;		/* CPHA CPOL Select */
	IP_SPI_DATA_ORDER       DataOrder;		/* MSB/LSB First */
	IP_SPI_SSEL_POL         SSELPol;		/* SSEL Polarity Select */
...
} IP_SPI_DELAY_CONFIG_Type;

/**
 * @brief	Enable/Disable SPI operation
 * @param	pSPI		: The base of SPI peripheral on the chip
 * @param	NewState	: New state, ENABLE or DISABLE
 * @return	Nothing
 */
void IP_SPI_Cmd(IP_SPI_002_Type *pSPI, FunctionalState NewState);
 ...
 */
STATIC INLINE void IP_SPI_DeInit(IP_SPI_002_Type *pSPI)
{
	IP_SPI_Cmd(pSPI, DISABLE);
}
 ...
 */
STATIC INLINE uint32_t IP_SPI_GetStatus(IP_SPI_002_Type *pSPI)
{
	return pSPI->STAT;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_ForceEOT(IP_SPI_002_Type *pSPI)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_ClearStatus(IP_SPI_002_Type *pSPI, uint32_t Flag)
{
	pSPI->STAT |= Flag;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_IntEnable(IP_SPI_002_Type *pSPI, uint32_t IntEnMsk)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_IntDisable(IP_SPI_002_Type *pSPI, uint32_t IntDisMsk)
{
 ...
 */
STATIC INLINE uint32_t IP_SPI_GetIntStatus(IP_SPI_002_Type *pSPI)
{
	return pSPI->INTSTAT;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_SendFrame(IP_SPI_002_Type *pSPI, uint16_t data)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_SetControlInfo(IP_SPI_002_Type *pSPI, uint8_t Flen, uint32_t Flag)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_SPI_SendFrameAndControl(IP_SPI_002_Type *pSPI, uint16_t TxData, uint8_t Flen, uint32_t Flag)
{
 ...
 * @return	receive data
 */
STATIC INLINE uint16_t IP_SPI_ReceiveFrame(IP_SPI_002_Type *pSPI)
{
 ...
 * @note	The SPI controller is disabled
 */
void IP_SPI_Init(IP_SPI_002_Type *pSPI, IP_SPI_CONFIG_Type *pConfig);
 ...
 * @note	The SPI controller is disabled
 */
void IP_SPI_DelayConfig(IP_SPI_002_Type *pSPI, IP_SPI_DELAY_CONFIG_Type *pConfig);
 ...
 */
void IP_SPI_LoopBackCmd(IP_SPI_002_Type *pSPI, FunctionalState NewState);
