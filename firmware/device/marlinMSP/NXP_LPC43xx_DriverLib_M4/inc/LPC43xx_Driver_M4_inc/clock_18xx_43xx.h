 ...
 * MAX_CLOCK_FREQ:<br>
 * This define, when set, identifies the running CPU clock rate of the system (change this to alter running CPU speed)<br>
 ...
 * @param	BaseClock	: CGU_BASE_CLK_T value indicating which base clock to get
 * @param	Input		: Pointer to CGU_CLKIN_T value of the base clock
 * @param	autoblocken	: Pointer to autoblocking value of the base clock
 * @param	powerdn		: Pointer to power down flag
 * @return	Nothing
 */
void Chip_Clock_GetBaseClockOpts(CGU_BASE_CLK_T BaseClock, CGU_CLKIN_T *Input, bool *autoblocken,
								 bool *powerdn);
 ...
 * @param	BaseClock	: CGU_BASE_CLK_T value indicating which base clock to check
 * @return	true if the base clock is enabled, false if disabled
 */
bool Chip_Clock_IsBaseClockEnabled(CGU_BASE_CLK_T BaseClock);
 ...
 */
void Chip_Clock_SetupPLL(CGU_CLKIN_T Input, CGU_USBAUDIO_PLL_T pllnum,
 ...
 * @return	Nothing
 */
void Chip_Clock_EnablePLL(CGU_USBAUDIO_PLL_T pllnum);
 ...
 * @return	Nothing
 */
void Chip_Clock_DisablePLL(CGU_USBAUDIO_PLL_T pllnum);
 ...
 */
uint32_t Chip_Clock_GetPLLStatus(CGU_USBAUDIO_PLL_T pllnum);
