...
${OBJECTDIR}/_ext/1360937237/NamespaceSample.o: ../src/NamespaceSample.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1360937237 
	@${RM} ${OBJECTDIR}/_ext/1360937237/NamespaceSample.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/NamespaceSample.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/NamespaceSample.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../../../../c-bowler/firmware/library/NR-Clib/development/BowlerStack/include" -I"../../../../c-bowler/firmware/library/NR-Clib/development/Platform/include" -MMD -MF "${OBJECTDIR}/_ext/1360937237/NamespaceSample.o.d" -o ${OBJECTDIR}/_ext/1360937237/NamespaceSample.o ../src/NamespaceSample.c   
