 ...
 * @return	Nothing
 */
void IP_ACMP_SetEdgeSelection(ACMP_001_T *pACMP, ACMP_001_EDGESEL_T edgeSel);
 ...
 * @return	Nothing
 */
void IP_ACMP_SetHysteresis(ACMP_001_T *pACMP, ACMP_HYS_001_T hys);
 ...
 * correct bitfield location in the CTRL register.
 */
void IP_ACMP_SetupAMCPRefs(ACMP_001_T *pACMP, ACMP_001_EDGESEL_T edgeSel,
						   uint32_t Posinput, uint32_t Neginput, ACMP_HYS_001_T hys);
