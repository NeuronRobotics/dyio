 ...
 */
STATIC INLINE void IP_REGFILE_Write(IP_REGFILE_001_Type *pREG, int index, uint32_t value)
{
 ...
 * powered in the RTC power domain.
 */
STATIC INLINE uint32_t IP_REGFILE_Read(IP_REGFILE_001_Type *pREG, int index)
{
