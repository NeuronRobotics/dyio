 ...
 * @ingroup IP_Drivers
 * Typically used for 175x/6x/7x/7x and 407xx devices.
 * @{
 */
...
/**
 * @brief GPIO port  (GPIO_PORT) for LPC175x_6x, LPC177x_8x
 */
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_GPIO_Init(IP_GPIO_002_Type *pGPIO)
{}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_GPIO_WritePortBit(IP_GPIO_002_Type *pGPIO, uint8_t Bit, bool Setting)
{
	if (Setting) {	/* Set Port */
		pGPIO->SET |= 1UL << Bit;
	}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_GPIO_WriteDirBit(IP_GPIO_002_Type *pGPIO, uint8_t Bit, bool Setting)
{
	if (Setting) {
		pGPIO->DIR |= 1UL << Bit;
	}
 ...
 */
STATIC INLINE bool IP_GPIO_ReadPortBit(IP_GPIO_002_Type *pGPIO, uint8_t Bit)
{
 ...
 */
STATIC INLINE bool IP_GPIO_ReadDirBit(IP_GPIO_002_Type *pGPIO, uint8_t Bit)
{
