 ...
 * @return	None
 */
void IP_WWDT_Init(IP_WWDT_001_Type *pWWDT);
 ...
 * @return	None
 */
STATIC INLINE void IP_WWDT_DeInit(IP_WWDT_001_Type *pWWDT)
{}
 ...
 * @return	none
 */
STATIC INLINE void IP_WWDT_SetTimeOut(IP_WWDT_001_Type *pWWDT, uint32_t timeout)
{
	pWWDT->TC = timeout;
}
 ...
 * @param	pWWDT	: pointer to WWDT register block
 * @param	clockSel	: Clock source selection (Or-ed value of WWDT_CLKSEL_*)
 * @return	none
 */
STATIC INLINE void IP_WWDT_SelClockSource(IP_WWDT_001_Type *pWWDT, uint32_t src)
{
 ...
 */
STATIC INLINE void IP_WWDT_Feed(IP_WWDT_001_Type *pWWDT)
{
	pWWDT->FEED = 0xAA;
	pWWDT->FEED = 0x55;
}
 ...
 */
STATIC INLINE void IP_WWDT_SetWarning(IP_WWDT_001_Type *pWWDT, uint32_t timeout)
{
 ...
 */
STATIC INLINE void IP_WWDT_SetWindow(IP_WWDT_001_Type *pWWDT, uint32_t timeout)
{
 ...
 */
STATIC INLINE void IP_WWDT_SetOption(IP_WWDT_001_Type *pWWDT, uint32_t options)
{
	pWWDT->MOD |= options;
}
 ...
 * WWDT_WDMOD_WDTOF).
 */
STATIC INLINE void IP_WWDT_UnsetOption(IP_WWDT_001_Type *pWWDT, uint32_t options)
{
 ...
 * @return	None
 */
STATIC INLINE void IP_WWDT_Start(IP_WWDT_001_Type *pWWDT)
{
 ...
 */
STATIC INLINE uint32_t IP_WWDT_GetStatus(IP_WWDT_001_Type *pWWDT)
{
	return pWWDT->MOD;
}
 ...
 * @return	None
 */
void IP_WWDT_ClearStatusFlag(IP_WWDT_001_Type *pWWDT, uint32_t status);

/**
 * @brief	Get the current value of WDT
 * @return	current value of WDT
 */
STATIC INLINE uint32_t IP_WWDT_GetCurrentCount(IP_WWDT_001_Type *pWWDT)
{
	return pWWDT->TV;
}
