...
{
	/* Disable RTC */
	IP_RTC_Enable(pRTC, DISABLE);

	/* Disable Calibration */
	IP_RTC_CalibCounterCmd(pRTC, DISABLE);
...
void IP_RTC_CntIncrIntConfig(IP_RTC_001_Type *pRTC, uint32_t cntrMask,
...
void IP_RTC_AlarmIntConfig(IP_RTC_001_Type *pRTC, uint32_t alarmMask,
						   FunctionalState NewState)
{
	if (NewState == ENABLE) {
