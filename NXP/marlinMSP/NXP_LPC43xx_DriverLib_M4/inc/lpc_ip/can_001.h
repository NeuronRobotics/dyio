...
typedef struct							/*!< CANn structure               */
{
	...
	__IO IP_CAN_001_RX_Type RX;			/*!< CAN Receive Registers*/
	__IO IP_CAN_001_TX_Type TX[3];		/*!< CAN Transmit Registers*/
} IP_CAN_001_Type;
...
} IP_CAN_STD_ID_Entry_Type;

/**
 * @brief Standard ID Range structure
 */
typedef struct {
	IP_CAN_STD_ID_Entry_Type LowerID;	/*!< Lower ID Bound, should be in 11-bit value*/
	IP_CAN_STD_ID_Entry_Type UpperID;	/*!< Upper ID Bound, should be in 11-bit value*/
} IP_CAN_STD_ID_RANGE_Entry_Type;
...
} IP_CAN_EXT_ID_Entry_Type;

/**
 * @brief Extended ID Range structure
 */
typedef struct {
	IP_CAN_EXT_ID_Entry_Type LowerID;	/*!< Lower ID Bound, should be in 29-bit value*/
	IP_CAN_EXT_ID_Entry_Type UpperID;	/*!< Upper ID Bound, should be in 29-bit value*/
} IP_CAN_EXT_ID_RANGE_Entry_Type;

/**
 * @brief Acceptance Filter Section Table structure
 */
typedef struct {
	IP_CAN_STD_ID_Entry_Type *FullCANSec;		/*!< The pointer to fullCAN section */
	uint16_t FullCANEntryNum;					/*!< FullCAN Entry Number */
	IP_CAN_STD_ID_Entry_Type *SffSec;			/*!< The pointer to individual Standard ID Section */
	uint16_t SffEntryNum;						/*!< Standard ID Entry Number */
	IP_CAN_STD_ID_RANGE_Entry_Type *SffGrpSec;	/*!< The pointer to  Group Standard ID  Section */
	uint16_t SffGrpEntryNum;					/*!< Group Standard ID Entry Number */
	IP_CAN_EXT_ID_Entry_Type *EffSec;			/*!< The pointer to Extended ID Section */
	uint16_t EffEntryNum;						/*!< Extended ID Entry Number */
	IP_CAN_EXT_ID_RANGE_Entry_Type *EffGrpSec;	/*!< The pointer to Group Extended ID Section */
 ...
 * @return	None
 */
STATIC INLINE void IP_CAN_DeInit(IP_CAN_001_Type *pCAN)
{}
 ...
 */
STATIC INLINE uint32_t IP_CAN_GetMode(IP_CAN_001_Type *pCAN)
{
 ...
 * @return	None
 */
STATIC INLINE void IP_CAN_SetCmd(IP_CAN_001_Type *pCAN, uint32_t command)
{
	pCAN->CMR = command;
}
 ...
 * @return	None
 */
STATIC INLINE void IP_CAN_SetEWL(IP_CAN_001_Type *pCAN, uint32_t ewl)
{
 ...
 */
STATIC INLINE uint8_t IP_CAN_GetEWL(IP_CAN_001_Type *pCAN)
{
 ...
 */
STATIC INLINE uint32_t IP_CAN_GetGlobalStatus(IP_CAN_001_Type *pCAN)
{
	return pCAN->GSR;
}
 ...
 */
STATIC INLINE uint32_t IP_CAN_GetStatus(IP_CAN_001_Type *pCAN)
{
	return pCAN->SR;
}
 ...
 */
STATIC INLINE uint32_t IP_CAN_GetIntStatus(IP_CAN_001_Type *pCAN)
{
	return pCAN->ICR;
}
 ...
 * @return	None
 */
STATIC INLINE void IP_CAN_AF_SetMode(IP_CAN_001_AF_Type *pCanAF, uint32_t AFMode)
{
	pCanAF->AFMR = AFMode;
}
 ...
 * @return	Mode
 */
STATIC INLINE uint32_t IP_CAN_AF_GetMode(IP_CAN_001_AF_Type *pCanAF)
{
	return pCanAF->AFMR;
}
...
/**
 * @brief	Enable/Disable the given interrupt of the CAN Controller
 * @param	pCAN	    : Pointer to CAN peripheral block
 ...
 */
Status IP_CAN_SetAFLUT(IP_CAN_001_AF_Type *pCanAF, IP_CAN_001_AF_RAM_Type *pCanAFRam, IP_CAN_AF_LUT_Type *pAFSections);
 ...
 */
uint16_t IP_CAN_GetEntriesNum(IP_CAN_001_AF_Type *pCanAF,
							  IP_CAN_001_AF_RAM_Type *pCanAFRam,
