 ...
 * @return	Nothing
 */
STATIC INLINE void IP_UART_Init(IP_USART_002_Type *pUART)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_UART_SetBaudRate(IP_USART_002_Type *pUART, uint32_t baudrate)
{
	pUART->BRG = baudrate;
}
 ...
 */
STATIC INLINE uint32_t IP_UART_GetBaudRate(IP_USART_002_Type *pUART)
{
	return pUART->BRG;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_UART_Transmit(IP_USART_002_Type *pUART, uint8_t data)
{
	pUART->TXDATA = data;
}
 ...
 */
STATIC INLINE uint8_t IP_UART_Receive(IP_USART_002_Type *pUART)
{
 ...
 */
STATIC INLINE uint32_t IP_UART_GetIntStatus(IP_USART_002_Type *pUART)
{
 ...
 */
STATIC INLINE uint32_t IP_UART_GetStatus(IP_USART_002_Type *pUART)
{
	return pUART->STAT;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void IP_UART_ClearStatus(IP_USART_002_Type *pUART, uint32_t StatusFlag)
{
 ...
 * @return	Nothing
 */
void IP_UART_Config(IP_USART_002_Type *pUART, UART_002_DATALEN_Type Databits,
					UART_002_PARITY_Type Parity, UART_002_STOPLEN_Type Stopbits);
 ...
 * @return	Nothing
 */
void IP_UART_IntEnable(IP_USART_002_Type *pUART, uint32_t UARTIntCfg, FunctionalState NewState);
