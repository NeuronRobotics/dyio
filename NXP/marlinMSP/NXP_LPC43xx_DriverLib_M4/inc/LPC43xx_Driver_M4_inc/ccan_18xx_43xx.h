 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_CCAN_IntEnable(LPC_CCAN_Type *pCCAN, FunctionalState NewState)
{
 ...
 */
STATIC INLINE uint32_t Chip_CCAN_GetIntID(LPC_CCAN_Type *pCCAN)
{
 ...
 */
STATIC INLINE uint32_t Chip_CCAN_GetStatus(LPC_CCAN_Type *pCCAN)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_CCAN_GetMsgObject(LPC_CCAN_Type *pCCAN, uint8_t msg_num, message_object *msg_buf)
{
 ...
 * @return	Nothing
 */
void Chip_CCAN_Init(LPC_CCAN_Type *pCCAN);
 ...
 * @return	Nothing
 */
void Chip_CCAN_DeInit(LPC_CCAN_Type *pCCAN);
 ...
 * @return	Nothing
 */
void Chip_CCAN_SetBitRate(LPC_CCAN_Type *pCCAN, uint32_t bit_rate);
 ...
 * @return	Nothing
 */
void Chip_CCAN_ClearStatus(LPC_CCAN_Type *pCCAN, ccan_status_t status);
 ...
 * @return	Nothing
 */
void Chip_CCAN_ClearIntPend(LPC_CCAN_Type *pCCAN, uint8_t msg_num, uint8_t TRxMode);
 ...
 * @return	Nothing
 */
void Chip_CCAN_Send (LPC_CCAN_Type *pCCAN, uint32_t RemoteEnable, message_object *msg_ptr);
 ...
 * @return	Nothing
 */
void Chip_CCAN_AddReceiveID(LPC_CCAN_Type *pCCAN, uint32_t rev_id);
 ...
 * @return	Nothing
 */
void Chip_CCAN_DeleteReceiveID(LPC_CCAN_Type *pCCAN, uint32_t rev_id);
