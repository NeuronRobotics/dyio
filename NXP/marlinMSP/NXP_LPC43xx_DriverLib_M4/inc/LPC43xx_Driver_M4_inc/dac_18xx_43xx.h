...
// FIXME LPC_DAC_Type *pDAC argument not needed for 18xx/43xx CHIP driver

/**
 * @brief	Initial DAC configuration
 *              - Maximum	current is 700 uA
 *              - Value to AOUT is 0
 * @param	pDAC : pointer to LPC_DAC_Type
 * @return	Nothing
 */
void Chip_DAC_Init(LPC_DAC_Type *pDAC);
 ...
 * @return	Nothing
 */
void Chip_DAC_DeInit(LPC_DAC_Type *pDAC);
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_DAC_UpdateValue(LPC_DAC_Type *pDAC, uint32_t dac_value)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_DAC_SetBias(LPC_DAC_Type *pDAC, uint32_t bias)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_DAC_ConfigDAConverterControl(LPC_DAC_Type *pDAC,
													 DAC_CONVERTER_CFG_Type *DAC_ConverterConfigStruct)
{
	IP_DAC_ConfigDAConverterControl(pDAC, DAC_ConverterConfigStruct);
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_DAC_SetDMATimeOut(LPC_DAC_Type *pDAC, uint32_t time_out)
{
 ...
 * @param	pDAC		: pointer to LPC_DAC_Typer
 * @return	interrupt/DMA time out status, should be SET or RESET
 */
STATIC INLINE IntStatus Chip_DAC_GetIntStatus(LPC_DAC_Type *pDAC)
{
