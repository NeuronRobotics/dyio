...
// FIXME SCT driver doesn't need SCT register block param, 1 peripheral per device
 ...
 */
STATIC INLINE void Chip_SCT_Config(LPC_SCT_Type *pSCT, uint32_t value)
{
 ...
 */
STATIC INLINE void Chip_SCT_ControlSetClr(LPC_SCT_Type *pSCT, uint32_t value, FunctionalState ena)
{
 ...
 */
STATIC INLINE void Chip_SCT_ConflictResolutionSet(LPC_SCT_Type *pSCT, uint8_t outnum, uint8_t value)
{
 ...
 */
STATIC INLINE void Chip_SCT_EventFlagClear(LPC_SCT_Type *pSCT, uint8_t even_num)
{
