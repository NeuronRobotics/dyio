...
SOURCEFILES_QUOTED_IF_SPACED=../src/Application/CartesianController.c ../src/Application/PID.c ../src/BowlerCallbacks/InitializationCallbacks.c ../src/BowlerCallbacks/AsyncManager.c ../src/BowlerCallbacks/UpstreamPackets.c ../src/BowlerCallbacks/DownStreamPackets.c ../src/Drivers/dma/UartDMARx.c ../src/Drivers/AVRInterface.c ../src/Drivers/CoProcCom.c ../src/Drivers/SPI.c ../src/Drivers/Switches.c ../src/Drivers/PPMReader.c ../src/Drivers/EEPROMMannager.c ../src/Drivers/Counter.c ../src/Drivers/SerialPassThrough.c ../src/Drivers/ADC.c ../src/Drivers/DyIODataTableManager.c ../../common/src/dyio/PinFunctions.c ../src/DyIO/ChannelMode.c ../src/DyIO/ChannelValues.c ../src/DyIO/Pin_State.c ../src/DyIO/ChannelConfig.c ../../common/src/Namespace_bcs_io/Namespace_bcs_io.c ../../common/src/Namespace_bcs_io/Abstract_bcs_io.c ../../common/src/Namespace_bcs_io/Debug_DyIO.c ../../common/src/Namespace_bcs_io/Bcs_IO_AdvancedAsync.c ../../common/src/Namespace_bcs_io_setmode/Abstract_bcs_io_setmode.c ../../common/src/Namespace_bcs_io_setmode/Namespace_bcs_io_setmode.c ../src/Namespace_bcs_safe/Abstract_bsc_safe.c ../src/Namespace_bcs_safe/Namespace_bcs_safe.c ../src/Namespace_dyio/Namespace_neuronrobotics_dyio.c ../src/Namespace_dyio/Namespace_bcs_pid_dypid.c ../src/Main.c ../src/DyIOMain.c
...
${OBJECTDIR}/_ext/1825615050/CartesianController.o: ../src/Application/CartesianController.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1825615050/CartesianController.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -fdata-sections -mips16 -O1 -I"../include" -I"../../common/include" -I"../../../c-bowler/BowlerStack/include" -I"../../../c-bowler/Platform/include" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/1825615050/CartesianController.o.d" -o ${OBJECTDIR}/_ext/1825615050/CartesianController.o ../src/Application/CartesianController.c    -DPROGRAMMER_DEBUG -DMAJOR_REV=3 -DMINOR_REV=11 -DFIRMWARE_VERSION=1
...
${OBJECTDIR}/_ext/1825615050/CartesianController.o: ../src/Application/CartesianController.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1825615050/CartesianController.o.d 
	@${RM} ${OBJECTDIR}/_ext/1825615050/CartesianController.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1825615050/CartesianController.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -fdata-sections -mips16 -O1 -I"../include" -I"../../common/include" -I"../../../c-bowler/BowlerStack/include" -I"../../../c-bowler/Platform/include" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/1825615050/CartesianController.o.d" -o ${OBJECTDIR}/_ext/1825615050/CartesianController.o ../src/Application/CartesianController.c    -DPROGRAMMER_DEBUG -DMAJOR_REV=3 -DMINOR_REV=11 -DFIRMWARE_VERSION=1
